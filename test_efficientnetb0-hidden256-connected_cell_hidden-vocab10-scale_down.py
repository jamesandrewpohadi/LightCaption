...
if __name__ == "__main__":
    ...
    parser.add_argument('-e','--encoder',default='models/encoder.efficientnetb0-glove.200d.std1-hidden256-connected_cell_hidden-vocab10-scale_down-5-6000.pth')
    parser.add_argument('-d','--decoder',default='models/decoder.efficientnetb0-glove.200d.std1-hidden256-connected_cell_hidden-vocab10-scale_down-5-6000.pth')
