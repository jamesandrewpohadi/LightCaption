...
if __name__ == "__main__":
    ...
    parser.add_argument('-embed','--embed',default=256,type=int)
    ...
    parser.add_argument('-e','--encoder',default='models/encoder-5-3000.ckpt')
    parser.add_argument('-d','--decoder',default='models/decoder-5-3000.ckpt')
