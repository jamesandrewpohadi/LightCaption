...
def test(args):
    ...
    encoder = Encoder(efficientnetBackbone,efficientnetBackbone.output_size,args.embed).to(device)
    ...
    for image_id in pbar:
        ...
        encoderTimer.toc()
        hidden_state = feature.unsqueeze(0)
        cell_state = torch.zeros(hidden_state.shape).to(device)
        decoderTimer.tic()
...
if __name__ == "__main__":
    ...
    parser.add_argument('-hd','--hidden',default=200,type=int)
    ...
    parser.add_argument('-e','--encoder',default='models/encoder.efficientnetb0-glove.200d-hidden200-connected_hidden-5-3000.pth')
    parser.add_argument('-d','--decoder',default='models/decoder.efficientnetb0-glove.200d-hidden200-connected_hidden-5-3000.pth')
