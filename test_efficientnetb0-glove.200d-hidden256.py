...
if __name__ == "__main__":
    ...
    parser.add_argument('-e','--encoder',default='models/encoder.efficientnetb0-glove.200d-hidden256-5-3000.pth')
    parser.add_argument('-d','--decoder',default='models/decoder.efficientnetb0-glove.200d-hidden256-5-3000.pth')
