...
model_path = './models'
val_caption_path = '../datasets/coco2014/trainval_coco2014_captions/captions_val2014.json'
...
encoder.load_state_dict(migrate_backbone(torch.load('models/encoder.glove.200d-5-3000.pth')))
