...
from models import EfficientNetBackbone, Encoder, Decoder, DecoderScaleDown
...
if __name__ == "__main__":
    ...
    parser.add_argument('-hd','--hidden',default=256,type=int)
    ...
    parser.add_argument('-e','--encoder',default='models/encoder.efficientnetb1-hidden256-connected_cell_hidden-vocab10-scale_down3-6-2000.pth')
    parser.add_argument('-d','--decoder',default='models/decoder.efficientnetb1-hidden256-connected_cell_hidden-vocab10-scale_down3-6-2000.pth')
