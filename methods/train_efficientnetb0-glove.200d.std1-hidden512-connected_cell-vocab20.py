...
if __name__ == "__main__":
    ...
    # data folders
    parser.add_argument('-v','--vocab',default='data/vocab20.pkl')
    ...
    parser.add_argument('-name','--name',default="efficientnetb0-glove.200d.std1-hidden512-connected_cell-vocab20")
