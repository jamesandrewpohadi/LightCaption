...
def main(args):
    ...
    decoder = DecoderAttent(args.embed, args.hidden, len(vocab), args.layer).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-name','--name',default="efficientnetb0-glove.200d.std1-hidden512-connected_cell-attent")
