...
if __name__ == "__main__":
    ...
    parser.add_argument('-ss','--save_step',default=2000,type=int)
    ...
    parser.add_argument('-name','--name',default="efficientnetb0-glove.200d.std1-hidden256-connected_cell_hidden-vocab10-scale_down4")
